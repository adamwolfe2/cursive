        ...
        {isLoading ? (
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              disabled={!stats?.referralCode}
              className="h-auto px-4 text-[13px] font-medium bg-zinc-900 text-white hover:bg-zinc-800 rounded-lg inline-flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
