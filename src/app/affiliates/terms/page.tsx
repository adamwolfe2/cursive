/**
 * /affiliates/terms — Partner Program Legal Agreement (static)
 */
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-16">
        <div className="mb-8">
          <Link href="/affiliates/apply" className="text-[12px] text-zinc-400 hover:text-zinc-600 transition-colors">
            ← Back to Partner Program
          </Link>
        </div>

        <h1 className="text-3xl font-bold text-zinc-900 mb-2">Cursive Partner Program Agreement</h1>
        <p className="text-[13px] text-zinc-400 mb-10">Version 1.0 — Effective March 4, 2026</p>

        <div className="prose prose-zinc max-w-none">
          <div className="space-y-8 text-[15px] text-zinc-700 leading-relaxed">

            <section>
              <h2 className="text-lg font-semibold text-zinc-900 mb-3">1. Program Overview</h2>
              <p>
                The Cursive Partner Program (the "Program") allows approved individuals and organizations ("Partners")
            ...
            <section>
              <h2 className="text-lg font-semibold text-zinc-900 mb-3">2. Commission Structure and Payment</h2>
              <p className="mb-3">
                Partners earn rewards based on their activation milestone tier:
              </p>
              <ul className="space-y-1 list-disc pl-5 mb-3">
                <li>Tiers 0–4 (0–49 activations): No recurring commission. Milestone cash bonuses only.</li>
                <li>Tier 5 (50–99 activations): 10% recurring commission on referred customers' payments.</li>
                <li>Tier 6 (100+ activations): 20% recurring commission on referred customers' payments, for life.</li>
              </ul>
              <p className="mb-3">
                Cash milestone bonuses:
              </p>
              ...
              <p className="mt-3">
                ...
                Stripe Connect onboarding to receive electronic transfers. A <strong>minimum payout threshold of $50</strong> applies —
                amounts below this threshold roll over to the following month.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-semibold text-zinc-900 mb-3">3. Clawbacks and Refunds</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-zinc-900 mb-3">4. FTC Disclosure Requirements</h2>
              <p>
                ...
                "affiliate link," "I'm a Cursive partner," or "I may earn a commission" is required by Federal
                Trade Commission guidelines. Failure to disclose may result in immediate program termination.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-semibold text-zinc-900 mb-3">5. Prohibited Conduct</h2>
              <p className="mb-3">Partners may not engage in the following:</p>
              <ul className="space-y-1 list-disc pl-5">
                <li><strong>Brand keyword bidding:</strong> Bidding on "Cursive," "meetcursive," or any Cursive trademark in paid search advertising.</li>
                <li><strong>Spam:</strong> Sending unsolicited emails or messages promoting your referral link.</li>
                <li><strong>False claims:</strong> Making any false, misleading, or unverified claims about Cursive's products or services.</li>
            ...
            <section>
              <h2 className="text-lg font-semibold text-zinc-900 mb-3">6. Termination</h2>
              <p>
                Cursive reserves the right to suspend or terminate a Partner's participation in the Program at any
            ...
            <section>
              <h2 className="text-lg font-semibold text-zinc-900 mb-3">7. Tax Responsibility</h2>
              <p>
                ...
                Numbers, EINs, or tax identification numbers in its own systems</strong> — this data is handled
            ...
            <section>
              <h2 className="text-lg font-semibold text-zinc-900 mb-3">8. Attribution</h2>
              <p>
                ...
                is credited to you. If the visitor already had another affiliate's cookie, your attribution
                will not overwrite it.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-semibold text-zinc-900 mb-3">9. Modifications</h2>
              <p>
            ...
            <div className="pt-4 border-t border-zinc-200">
              <p className="text-[13px] text-zinc-400">
                Version 1.0 — Effective March 4, 2026 · Questions? Contact{' '}
                <a href="mailto:adam@meetcursive.com" className="text-zinc-600 hover:text-zinc-900">
