...
export const metadata: Metadata = generateMetadata({
  ...
  description: 'Match 60\u201370% of anonymous website visitors deterministically against an offline-rooted identity graph of 280M+ verified consumer profiles, refreshed every 30 days against NCOA. Decision-maker contacts, pages viewed, and intent scores in real-time.',
  keywords: [
...
const productSchema = {
  ...
  "description": "Match 60\u201370% of anonymous website visitors deterministically against an offline-rooted identity graph of 280M+ verified consumer profiles refreshed every 30 days against NCOA. Turn unknown traffic into qualified leads with company and individual-level data.",
