...
export const metadata = generateMetadata({
  title: 'Intent Data Audiences — 450B+ Monthly Signals, Target In-Market Buyers | Cursive',
...
const intentFAQs = [
  {
    ...
    answer: 'Intent data tracks online research behavior to identify people actively researching topics related to your product or service. Cursive tracks 450B+ monthly signals across 30,000+ commercial categories — website visits, content downloads, search queries, and social interactions — to identify in-market buyers before they raise their hand.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Cursive tracks 450B+ monthly intent signals vs Bombora\'s 300B+, with updates every 7 days vs monthly snapshots from many providers. Unlike 6sense (which requires $50k-$200k/year enterprise contracts), Cursive\'s intent audiences are available starting at $1,000/month with no long-term commitment.',
  },
  {
