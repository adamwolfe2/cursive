...
import { Calendar, Clock, ArrowLeft, BarChart3, Check, X } from "lucide-react"
      ...
      <MachineView>
        <MachineContent>
          ...
          <MachineSection title="Key Takeaways">
            <MachineList items={[
              "B2B analytics are hard: 27 touchpoints per deal, 6-10 stakeholders, 98% anonymous traffic",
              "Focus on pipeline and revenue metrics, not vanity metrics like page views",
              "Position-based (U-shaped) attribution is recommended for most B2B companies",
              "Visitor identification closes the anonymous traffic gap, giving 70-85% journey visibility",
              "Website-to-pipeline conversion rate is the single most important metric to track",
            ]} />
          </MachineSection>

          <MachineSection title="Metrics That Matter">
            <div className="space-y-4">
              <div>
                <p className="font-bold text-gray-900 mb-2">Tier 1 - Revenue Metrics (Board-level):</p>
                <MachineList items={[
                  "Marketing-sourced revenue: closed-won revenue from marketing-generated leads",
                  "Marketing-influenced revenue: closed-won revenue where marketing had any touchpoint",
                  "Pipeline generated: total dollar value of new marketing-created opportunities",
                  "Cost per opportunity: total marketing spend / qualified opportunities generated",
                ]} />
              </div>
              <div>
                <p className="font-bold text-gray-900 mb-2">Tier 2 - Efficiency Metrics:</p>
                <MachineList items={[
                  "Speed-to-lead: benchmark under 5 min inbound, under 24 hrs for identified visitors",
                  "MQL-to-opportunity conversion rate: target 15-25% for B2B",
          ...
          <MachineSection title="Attribution Models Compared">
            <MachineList items={[
              "First-Touch: 100% credit to first touchpoint. Best for awareness measurement. Low B2B accuracy.",
              "Last-Touch: 100% credit to last touchpoint. Best for conversion optimization. Low B2B accuracy.",
              "Linear: Equal credit across all touchpoints. Balanced starting point. Medium accuracy.",
              "Position-Based (Recommended): 40% first touch, 40% conversion touch, 20% middle. High B2B accuracy.",
              "Time-Decay: More credit to recent touchpoints. Best for long enterprise cycles. High accuracy.",
            ]} />
          </MachineSection>

          <MachineSection title="Dashboard Structure">
            <MachineList items={[
              "Section 1: Pipeline Summary - pipeline vs target, marketing-sourced revenue, cost per opportunity",
              "Section 2: Channel Performance - pipeline by channel with cost per opportunity",
              "Section 3: Visitor Intelligence - identified companies by ICP fit and intent level",
              "Section 4: Content & Campaign Performance - ranked by pipeline influence, not traffic",
              "Section 5: Funnel Conversion Rates - visitor to identified to qualified to opportunity to closed-won",
            ]} />
          </MachineSection>

          <MachineSection title="Visitor Data in Attribution">
            <p className="text-gray-700 mb-3">
              Without visitor identification, attribution only sees 2-5% of the buyer journey (starting at form fill). With visitor identification, you see 70-85% of the journey by resolving anonymous traffic to company-level identities. This enables account-level journey stitching and fair credit across the full funnel.
            </p>
          </MachineSection>

          <MachineSection title="Advanced Analytics Strategies">
            <MachineList items={[
              "Dark funnel measurement: track 'direct' and 'organic brand' traffic separately for offline influence",
              "Cohort analysis: group leads by month identified, track funnel progression over time",
              "Account-level attribution: aggregate touchpoints across all stakeholders at a company",
              "Incrementality testing: controlled experiments to measure true channel value",
              "Predictive pipeline modeling: forecast future pipeline based on current activity signals",
            ]} />
          </MachineSection>

          <MachineSection title="Related Resources">
            <MachineList items={[
              { label: "CRM Integration & Data Enrichment Guide", href: "/blog/crm-integration", description: "Connect visitor data to HubSpot, Salesforce, and your marketing stack" },
              { label: "B2B Retargeting Strategies", href: "/blog/retargeting", description: "Cross-platform retargeting using first-party visitor data" },
              { label: "ICP Targeting Framework", href: "/blog/icp-targeting-guide", description: "Define and target your ideal customer profile" },
              { label: "Cursive Platform", href: "/platform", description: "Real-time visitor tracking, attribution, and pipeline reporting" },
              { label: "Visitor Identification", href: "/visitor-identification", description: "Identify 70% of anonymous B2B website traffic" },
            ]} />
          </MachineSection>

          <MachineSection title="Get Started with Cursive">
            <p className="text-gray-700 mb-3">
              Cursive provides real-time visitor identification, multi-channel attribution, and revenue reporting in a single dashboard. See which campaigns generate qualified leads and prove marketing ROI with data.
            </p>
            <MachineList items={[
