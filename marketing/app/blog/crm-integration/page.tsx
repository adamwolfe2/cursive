      ...
      <MachineView>
        <MachineContent>
          <MachineSection title="Key Takeaways">
            <MachineList items={[
              "CRM integration connects your marketing/sales tools into a unified data layer so every team works from the same intelligence",
              "CRM data decays at 27% per year; enrichment automatically keeps records current with firmographic, technographic, behavioral, and intent data",
              "Syncing visitor identification data to your CRM lets sales reps see which companies visited your site in real-time",
              "Five essential automation workflows: high-intent alerts, lead scoring loops, sequence enrollment, retargeting sync, and pipeline intelligence",
              "Intent-based CRM workflows report 3-5x higher conversion rates compared to traditional cold outreach",
            ]} />
          </MachineSection>

          <MachineSection title="Four Types of CRM Enrichment">
            <MachineList items={[
              "Firmographic: industry, employee count, revenue, location, funding history",
              "Technographic: technology stack detection (Salesforce, AWS, Marketo, etc.)",
              "Behavioral: website pages visited, session duration, content downloads, visit frequency",
              "Intent: first-party signals (pricing page views) and third-party signals (researching your category across the web)",
            ]} />
          </MachineSection>

          <MachineSection title="Visitor-to-CRM Sync Process">
            <MachineList items={[
              "Step 1: Identify the visitor using IP intelligence and device fingerprinting (up to 70% of B2B traffic)",
              "Step 2: Enrich the record with firmographic, technographic, and contact data",
              "Step 3: Match to existing CRM record or create new record with all fields populated",
              "Step 4: Trigger workflows based on behavior (pricing page visit, return visits, ICP match)",
            ]} />
          </MachineSection>

          <MachineSection title="HubSpot vs. Salesforce Integration">
            <MachineList items={[
              "HubSpot: Low setup complexity (15 min), native workflow triggers, built-in attribution, limited custom objects",
              "Salesforce: Medium setup (1-2 hours), full custom object support, Process Builder/Flow triggers, Campaign attribution",
              "Both support real-time sync and bi-directional data flow",
              "Cursive offers 200+ native integrations covering both platforms and more",
            ]} />
          </MachineSection>

          <MachineSection title="Five Automation Workflows">
            <MachineList items={[
              "High-Intent Visitor Alert: Notify reps instantly when ICP accounts visit pricing/demo pages",
              "Lead Scoring Enrichment Loop: Recalculate scores when new data enters (form fills, visitor matches, intent signals)",
              "Automated Sequence Enrollment: Enroll ICP-fit, high-intent visitors in outreach sequences automatically",
              "Account-Based Retargeting Sync: Add non-converting target accounts to LinkedIn, Google, and Meta retargeting audiences",
              "Pipeline Intelligence: Alert deal owners when prospects revisit website during active negotiations",
            ]} />
          </MachineSection>

          <MachineSection title="Common CRM Integration Mistakes">
            <MachineList items={[
              "Over-syncing everything without ICP filters floods reps with noise",
              "No duplicate management creates polluted CRM records",
              "One-way sync only causes data drift between systems",
              "Ignoring data hygiene lets 27% annual decay erode record quality",
              "Not measuring integration ROI makes it hard to justify continued investment",
            ]} />
          </MachineSection>

          <MachineSection title="Related Resources">
            <MachineList items={[
              { label: "Visitor Identification", href: "/visitor-identification", description: "Identify anonymous B2B website visitors in real-time" },
              { label: "Intent Audiences", href: "/intent-audiences", description: "Combine first-party and third-party intent signals" },
              { label: "200+ Integrations", href: "/integrations", description: "Native CRM, marketing automation, and sales tool integrations" },
              ...
              { label: "Scaling Outbound", href: "/blog/scaling-outbound", description: "Scale multi-channel outreach without sacrificing quality" },
              { label: "Marketing Analytics", href: "/blog/analytics", description: "Build dashboards that prove marketing ROI" },
            ]} />
          </MachineSection>

          <MachineSection title="Get Started with Cursive">
            <p className="text-gray-700">
              Cursive connects your entire marketing stack with 200+ native integrations. Visitor identification data syncs to Salesforce, HubSpot, and every major CRM in real-time. No Zapier middleware, no manual exports.
            </p>
            <p className="mt-2">
              <MachineLink href="/platform">See the platform</MachineLink> | <MachineLink href="/integrations">Explore integrations</MachineLink>
            </p>
          </MachineSection>
        </MachineContent>
      </MachineView>
