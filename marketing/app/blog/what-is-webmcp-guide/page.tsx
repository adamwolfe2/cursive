        ...
        <section className="py-16 bg-white">
          <Container>
            <article className="max-w-3xl mx-auto prose prose-lg prose-blue">
              ...
              <p>
                If you want to see who&apos;s already visiting your site &mdash; human or AI agent &mdash; and start turning that traffic into pipeline, <a href="https://cal.com/cursiveteam/30min" target="_blank" rel="noopener noreferrer">book a demo</a> and we&apos;ll show you in real time. The agentic web rewards the companies that are ready for it. Don&apos;t be the one the agents skip.
              </p>
        ...
        <MachineContent>
          ...
          <MachineSection title="Get Started with Cursive">
            ...
            <MachineList items={[
              ...
              { label: "Pricing", href: "/pricing", description: "Self-serve plans from $97/month, no setup fee" },
