      ...
      <MachineView>
        <MachineContent>
          ...
          <MachineSection title="Key Takeaways">
            <MachineList items={[
              "Targeted B2B campaigns generate 3-5x higher conversion rates than generic outreach",
              "Advanced segmentation drives 760% more revenue from email campaigns (Salesforce data)",
              "Four pillars of segmentation: firmographic, technographic, intent, and engagement data",
              "Combined first + third-party intent data is 10-15x better than no intent data",
              "67% of B2B marketing budget is wasted on unqualified leads due to poor targeting",
            ]} />
          </MachineSection>

          <MachineSection title="Building Your ICP">
            <MachineList items={[
              "Step 1: Analyze top 20 customers by revenue, retention, and NPS for common patterns",
              "Step 2: Identify negative signals from churned customers and lost deals",
              "Step 3: Weight criteria by correlation with customer success (industry 30%, size 20%, revenue 20%, tech 15%, intent 15%)",
              "Step 4: Validate with intent data to confirm ICP segments correlate with buying behavior",
            ]} />
          </MachineSection>

          <MachineSection title="Four Pillars of B2B Segmentation">
            <MachineList items={[
              "Firmographic: industry, company size, geography, funding stage",
              "Technographic: CRM platform, marketing automation, cloud infrastructure, competitor usage",
              "Intent: content consumption, search queries, website behavior, research surge detection",
              "Engagement: email interactions, page views, webinar attendance, content downloads",
            ]} />
          </MachineSection>

          <MachineSection title="7 Proven Segment Strategies">
            <MachineList items={[
              "In-Market ICP Accounts: ICP match + active purchase intent signals (3-5x conversion rate)",
              "Competitor Displacement: technographic data + 'alternatives' searches + renewal timing",
              "Technology Trigger: recent tool adoptions creating buying opportunities",
              "Expansion Look-alikes: matching attributes of top expanding customers",
              "Website Re-engagement: visitor identification + page/frequency/ICP scoring",
              "Event-Triggered: funding rounds, leadership changes, office expansions",
              "Seasonal/Cyclical: budget planning cycles, contract renewal windows",
            ]} />
          </MachineSection>

          <MachineSection title="Implementation Timeline">
            <MachineList items={[
              "Week 1: Audit customer data, document ICP, identify data gaps",
              "Week 2: Connect CRM, implement visitor tracking, configure intent signals",
              "Week 3: Build 3-5 segments, create suppression lists, assign channels",
              "Week 4: Launch campaigns, track metrics, A/B test segment criteria",
            ]} />
          </MachineSection>

          <MachineSection title="Targeting Benchmarks">
            <MachineList items={[
              "Email Reply Rate: Poor <2%, Good 5-10%, Excellent 15%+",
              "Meeting Book Rate: Poor <1%, Good 2-5%, Excellent 8%+",
              "Opportunity Rate: Poor <10%, Good 15-25%, Excellent 30%+",
              "Win Rate: Poor <15%, Good 20-30%, Excellent 35%+",
              "CAC Payback: Poor 18+ months, Good 9-12, Excellent <6",
            ]} />
          </MachineSection>

          <MachineSection title="Related Resources">
            <MachineList items={[
              { label: "ICP Targeting Framework", href: "/blog/icp-targeting-guide", description: "5-step framework for defining your ideal customer profile" },
