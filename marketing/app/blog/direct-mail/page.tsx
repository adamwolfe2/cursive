      ...
      <MachineView>
        <MachineContent>
          <MachineSection title="Key Takeaways">
            <MachineList items={[
              "Direct mail average response rate is 4.4% vs. 0.12% for email (DMA data)",
              "Trigger-based direct mail achieves 3-5x higher conversion rates than digital-only campaigns",
              "Modern direct mail automation: digital trigger fires, address resolved, piece personalized, printed on demand, delivery tracked",
              "Seven proven trigger strategies ranked by intent: pricing page visit, demo abandonment, competitor page visit, return visits, content threshold, closed-lost re-engagement, contract renewal window",
              "The 7-day surround-sound sequence (LinkedIn + retargeting + direct mail + email) achieves 12-18% meeting book rates",
              "Direct mail ROI can reach 5-20x when targeting high-intent, ICP-qualified accounts",
            ]} />
          </MachineSection>

          <MachineSection title="Direct Mail vs. Digital Statistics">
            <MachineList items={[
              "4.4% direct mail response rate vs. 0.12% for email",
              "70% of consumers say direct mail is more personal than digital",
              "5-9 days average lifespan of direct mail in a home/office vs. 2 seconds for a digital ad",
              "3-5x higher conversion when direct mail is paired with digital campaigns",
            ]} />
          </MachineSection>

          <MachineSection title="Trigger Strategy Benchmarks">
            <MachineList items={[
              "Pricing Page Visit: 5-8% response rate, $1.00/piece, $12-$20 CPA",
              "Demo Abandonment: 6-10% response rate, $1.00/piece, $10-$17 CPA",
              "Competitor Page: 4-7% response rate, $1.00/piece, $14-$25 CPA",
              "Return Visit: 3-5% response rate, $1.00/piece, $20-$33 CPA",
              "Content Threshold: 2-4% response rate, $1.00/piece, $25-$50 CPA",
              "Closed-Lost: 2-4% response rate, $1.50/piece, $38-$75 CPA",
              "Renewal Window: 1-3% response rate, $1.50/piece, $50-$150 CPA",
            ]} />
          </MachineSection>

          <MachineSection title="Implementation Timeline">
            <MachineList items={[
              "Week 1: Define triggers, design mail templates, set up visitor tracking and data platform",
              "Week 2: Select print partner (Lob, PostPilot, Sendoso), configure address verification, build automation workflow",
              "Week 3: Send test pieces, run small batch (50-100), verify tracking mechanisms",
              "Week 4: Launch for full audience, set volume caps, monitor daily, add triggers as proven profitable",
            ]} />
          </MachineSection>

          <MachineSection title="Budget Planning">
            <MachineList items={[
              "Starter: 100 postcards/month at $1.00 = $100/month",
              "Growth: 500 postcards/month at $0.85 = $425/month",
              "Scale: 2,000 pieces/month at $0.75 = $1,500/month",
              "Enterprise: 5,000+ mixed formats at $1.50 avg = $7,500+/month",
            ]} />
          </MachineSection>

          <MachineSection title="ROI Measurement Methods">
            <MachineList items={[
              "Unique landing pages per campaign for direct response tracking",
              "Dynamic QR codes on each piece (2-3x higher scan rate than typed URLs)",
              "Holdout groups: send to 80%, withhold 20% to measure true incremental lift",
              "CRM matchback: match recipients to new opportunities within 30 days of delivery",
            ]} />
          </MachineSection>

          <MachineSection title="Related Resources">
            <MachineList items={[
              { label: "Visitor Identification", href: "/visitor-identification", description: "Identify anonymous B2B website visitors to power direct mail triggers" },
              { label: "Direct Mail Feature", href: "/direct-mail", description: "Learn how Cursive's direct mail automation works" },
              { label: "Audience Targeting", href: "/blog/audience-targeting", description: "Build targeted audience segments for direct mail campaigns" },
              { label: "Scaling Outbound", href: "/blog/scaling-outbound", description: "Add direct mail to multi-channel outbound campaigns" },
              { label: "Data Platforms", href: "/blog/data-platforms", description: "Choose the right data platform for address enrichment" },
              { label: "ICP Targeting Guide", href: "/blog/icp-targeting-guide", description: "Target the right accounts with a proven ICP framework" },
            ]} />
          </MachineSection>

          <MachineSection title="Get Started with Cursive">
            <p className="text-gray-700">
              Cursive automates the entire direct mail process: identify website visitors, verify addresses, trigger personalized postcards, and track delivery. Combine digital precision with offline impact for 3-5x higher conversion rates.
            </p>
            <p className="mt-2">
              <MachineLink href="/direct-mail">Explore direct mail automation</MachineLink> | <MachineLink href="/platform">See the platform</MachineLink>
            </p>
          </MachineSection>
        </MachineContent>
      </MachineView>
