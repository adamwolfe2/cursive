        ...
        <MachineContent>
          ...
          <MachineSection title="Get Started with Cursive">
            ...
            <MachineList items={[
              ...
              { label: "Book a Demo", href: "https://cal.com/gotdarrenhill/30min", description: "30-minute consultation and product walkthrough" }
            ]} />
          </MachineSection>
        </MachineContent>
      </MachineView>
