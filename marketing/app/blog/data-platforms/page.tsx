      ...
      <MachineView>
        <MachineContent>
          <MachineSection title="Key Takeaways">
            <MachineList items={[
              "Poor data quality costs organizations an average of $12.9 million per year (Gartner); 30% of B2B contact data decays annually",
              "Four types of B2B data platforms: Contact/Company databases, Customer Data Platforms (CDPs), Intent Data platforms, and Unified Intelligence platforms",
              "Evaluate data quality across five dimensions: accuracy, completeness, freshness, coverage, and deliverability",
              "Use a weighted evaluation framework: Data Quality (30%), Feature Fit (25%), Integration Depth (20%), Total Cost (15%), Vendor Reliability (10%)",
              "Three enrichment strategies: Real-time (per-record, <1s), Batch (thousands at once), and Continuous (ongoing re-enrichment)",
              "For 95% of B2B teams, buying a platform is the right choice over building custom data infrastructure",
            ]} />
          </MachineSection>

          <MachineSection title="B2B Data Platform Types Compared">
            <MachineList items={[
              "Contact/Company DB (ZoomInfo, Apollo, Lusha): Contacts, firmographics, emails, phones. Starting at $5k/year. Best for outbound prospecting.",
              "CDP (Segment, mParticle): Unified first-party profiles. Starting at $12k/year. Best for multi-channel personalization.",
              "Intent Data (Bombora, G2): Purchase intent signals. Starting at $20k/year. Best for ABM prioritization.",
              "Unified Intelligence (Cursive): All of the above + visitor ID. Starting at $99/month. Best for full-stack teams.",
            ]} />
          </MachineSection>

          <MachineSection title="Five Data Quality Dimensions">
            <MachineList items={[
              "Accuracy: 85-95% benchmark for firmographic data, 70-85% for contact data",
              "Completeness: 80%+ fill rates for firmographic fields, 60-80% for contact details",
              "Freshness: Top platforms re-verify key records monthly with last-verified timestamps",
              "Coverage: 70%+ match rate against your target account list is the benchmark",
              "Deliverability: 90%+ email deliverability, 60%+ phone connect rates for direct dials",
            ]} />
          </MachineSection>

          <MachineSection title="Enrichment Strategies">
            <MachineList items={[
              "Real-Time: Enrich at point of capture (<1 second latency). Best for inbound leads and visitor identification.",
              "Batch: Process thousands of records on a schedule. Best for initial CRM cleanup and quarterly data hygiene.",
              "Continuous: Automatic re-enrichment when changes detected. Best for tracking job changes and maintaining freshness.",
            ]} />
          </MachineSection>

          <MachineSection title="Integration Architecture">
            <MachineList items={[
              "Hub-and-spoke model with data platform as central hub",
              "Key integration points: CRM, marketing automation, sales engagement, advertising platforms, data warehouses",
              "Best practices: single source of truth, deduplication rules, consistent field mapping, error monitoring, rate limiting",
            ]} />
          </MachineSection>

          <MachineSection title="Build vs. Buy">
            <MachineList items={[
              "Build: Full control but requires 2-4 engineers for 3-6 months, $300k-$700k+ Year 1 cost, ongoing $200k-$500k/year maintenance",
              "Buy: Production-ready in days, vendor-maintained data quality, predictable pricing at $1,200-$60,000+/year",
              "95% of B2B teams should buy rather than build",
            ]} />
          </MachineSection>

          <MachineSection title="Related Resources">
            <MachineList items={[
              { label: "Audience Targeting Guide", href: "/blog/audience-targeting", description: "Data-driven segmentation strategies for B2B marketing" },
              { label: "Clearbit Alternatives", href: "/blog/clearbit-alternatives-comparison", description: "Compare top B2B data enrichment and visitor identification tools" },
