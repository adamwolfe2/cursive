  ...
  execute: async (params) => {
    ...
    return {
      ...
      full_comparison_url: "https://www.meetcursive.com/blog/..."
            ...
            <p>
              If you want Cursive to identify who&apos;s visiting <em>your</em> site &mdash; human or agent &mdash; <a href="https://cal.com/cursiveteam/30min" target="_blank" rel="noopener noreferrer">book a free AI audit</a>. We&apos;ll show you exactly which companies are on your site right now, what pages they&apos;re viewing, and how to reach them before your competitors do.
            </p>
